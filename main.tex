...
\end{bemerkung}
\begin{beispiel}
    Konjugiertenklassen in $D_3$. Erzugende: $x$ (Drehung) und $y$ (Spiegelung).
...
\begin{proof}
    ...
    $\implies$ es gibt weitere Konjugiertenklassen mit nur einem Element.
...
Erinnerung: $I\ug SO(3)$ die Untergruppe der Drehungen, die das Dodekaeder $D\subset R^3$ erhalten.
